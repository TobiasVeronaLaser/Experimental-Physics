...
\begin{enumerate}[start=2, label=(\alph*)]
    ...
    \begin{tcolorbox}[title=Antwort auf Frage, breakable]
        ...
        Für leichte Kerne (z.B. Li, Be) ist dieses Modell weniger geeignet, da dort die Nukleonenverteilung stärker strukturiert ist und deutliche Abweichungen von einer homogenen Dichte auftreten.
    \end{tcolorbox}
